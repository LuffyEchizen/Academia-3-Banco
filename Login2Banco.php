...
<body background="images/Funlam.jpg" style="background-attachment: fixed" >
	<center bgcolor="red"><div class="tit"><h2 style="color: #0000FF; ">Inicio de sesión</h2>
		<center><div class="Ingreso">

	<table border="0" align="center" valign="middle">
		<tr>
		<td rowspan=2>
                    <form action="ValidarBanco.php" method="post">
